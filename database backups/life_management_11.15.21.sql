...
(11, 'Physical Health', '50.00', 'M', '', '2021-11-11 03:31:57', b'1'),
(12, 'Mental Health', '20.00', 'M', '', '2021-11-11 03:32:11', b'1'),
(13, 'Investment', '50.00', 'M', '', '2021-11-11 03:32:22', b'1'),
(14, 'Fitness', '20.00', 'M', '', '2021-11-11 03:32:51', b'0'),
(15, 'Side Hustle', '30.00', 'M', '', '2021-11-11 03:33:01', b'1'),
(16, 'Decoration', '20.00', 'M', '', '2021-11-11 03:33:13', b'1'),
(17, 'Relationship', '0.00', 'M', '', '2021-11-11 03:33:48', b'1');
...
(37, 'ALDI', 'Two packs of water bottles', '2', '6.30', '2021-11-09 00:00:00', '', b'0'),
...
(46, 'Moe Joe Coffee', 'Iced Hazelnut Latte w/Oat milk', '2', '4.91', '2021-11-11 00:00:00', '', b'1'),
(47, 'Starbucks', 'Venti Iced Peppermint Latte', '2', '6.27', '2021-11-12 00:00:00', 'cash', b'1'),
(48, 'Swamp Rabbit Cafe', 'GF Pesto Turkey Sandwich w/Creme cheese and chives chips', '2', '7.60', '2021-11-12 00:00:00', '', b'1'),
(49, 'Famous Hair - Woodruff road', 'Haircut', '5', '19.75', '2021-11-12 00:00:00', 'gave her a 5 dollar tip', b'1'),
(50, 'Publix', 'Got drinks for reward', '2', '7.77', '2021-11-12 00:00:00', 'helps me program good hehe', b'1'),
(51, 'Chick-fil-A', '8 count grilled nuggets with kale crunch side and med fries', '2', '10.08', '2021-11-12 00:00:00', 'Dinner', b'1'),
(52, 'Nana', 'Paid back for borrowing', '1', '200.00', '2021-11-13 00:00:00', '', b'0'),
(54, 'Chick-fil-A', '8 count grilled nuggets with med fries', '2', '7.74', '2021-11-13 00:00:00', 'went with mason', b'1'),
(55, 'Ingles', 'protein bars and a starbeez coffee', '2', '6.37', '2021-11-13 00:00:00', 'with mason', b'1'),
(56, 'Ingles', 'Got snacks and zevias for friends', '2', '6.37', '2021-11-13 00:00:00', '', b'0'),
(57, 'Red Bowl', 'Sesame Tofu with broccoli and fried rice', '2', '15.53', '2021-11-13 00:00:00', 'I couldnt eat the tofu because it was wrapped in gluten, but I took it to my friends house and let them have it', b'1'),
(58, 'Ingles', 'Got snacks and zevia for friends', '2', '16.28', '2021-11-13 00:00:00', '', b'1'),
(59, 'Carolina Ren Fair', 'Ticket', '9', '28.50', '2021-11-13 00:00:00', '', b'1'),
(60, 'QT', 'Got a snack for the drive home from the ren fair', '2', '3.99', '2021-11-14 00:00:00', '', b'1'),
(61, 'Swamp Rabbit Cafe', 'GF Turkey Pesto Sandwich with two bags of chips', '2', '15.44', '2021-11-15 00:00:00', 'Lunch', b'1'),
(62, 'QT', 'Full tank of gas', '7', '34.09', '2021-11-15 00:00:00', '', b'1'),
(63, 'QT', 'Two steaz teas, a bag of jalapeno cheetos and a kind bar', '2', '7.28', '2021-11-15 00:00:00', '', b'1'),
(64, 'Carolina Ren Fair', 'Everything bought at the ren fair is in the notes', '9', '43.25', '2021-11-14 00:00:00', 'tomatoes for mason to throw at person $5, fries $3, turkey leg $10, hot almond coffee $5.25, circulation herb extract $16, chocolate amaretto truffle ball $3, bet for mason to jump and touch a flag $1', b'1');
...
(6, 'Nana', 'Borrowed money', '200.00', '2021-11-08 00:00:00', 'Didnt have enough money this week', b'0');
...
(1, 'Closer to Job', 'Pro', '-Distance, -Gas, -Vehicle Miles, +Free Time', b'1'),
(2, 'Further from Job', 'Con', '+Distance, +Gas, +Vehicle Miles, -Free Time', b'1'),
(3, 'Peaceful Atmosphere', 'Pro', '-Stress, +Harmony', b'1'),
(4, 'Congested City/Town Area', 'Con', '+Stress, -Harmony', b'1');
...
INSERT INTO `users` (`user_id`, `id_role`, `user_name`, `user_fname`, `user_lname`, `user_dob`, `user_created`, `user_notes`, `is_active`) VALUES
(1, 1, 'nmerck', 'Nathaniel', 'Merck', '1997-11-19 04:00:00', '2021-11-13 21:17:47', '', b'1');
...
INSERT INTO `user_roles` (`role_id`, `role_name`, `role_notes`, `is_active`) VALUES
(1, 'Admin', 'Has access and full control to everything in the system.', b'1'),
(2, 'Premium', 'A member with paid membership to the site.', b'1'),
(3, 'Member', 'A member with access to the site.', b'1');
COMMIT;
